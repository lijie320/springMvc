...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/update/${param.foodId}" method="post" enctype="multipart/form-data">
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							<td>价格</td>
							<td><input type="text" name="money" class="InputStyle" value="${param.money }"/> *</td>
						</tr>
						...
						<tr>
							...
							<td>
									...
									src="${pageContext.request.contextPath}/image/${param.imagepath}">

								<input type="file" name="imageUrl" value="${path}"/> *
							</td>
						</tr>
					</table>
				</div>
